        ...
        <div className="mt-5 flex flex-col gap-2.5">
          {onTriggerOfficialPopup && (
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2.5 py-3 px-4 bg-[#1a73e8] hover:bg-[#1557b0] text-white font-medium text-xs rounded-xl shadow-xs transition-all cursor-pointer active:scale-98 disabled:opacity-50"
            >
              ...
              <span>{isLoading ? "Abrindo janela..." : "Reabrir Janela Oficial do Google (Popup)"}</span>
            </button>
          )}
